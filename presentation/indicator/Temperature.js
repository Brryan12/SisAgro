...
var temperature = {
  ...
  number: function (title, data) {
    var headers = ee.List([
      ...
      { id: "tempAvg", label: "Promedio", type: "number", unit: "°C" },
      { id: "tempMax", label: "Máxima", type: "number", unit: "°C" },
      { id: "tempMin", label: "Mínima", type: "number", unit: "°C" }
    ]);
  ...
  chart: function (title, d) {
    ...
    var data_ = {
      ...
      seriesNames: ["Promedio", "Máxima", "Mínima"],
...
function format(name, filter, resp) {
  var title = Utils.graphicTitle("Temperaturas promedio en °C ", filter.yearRange, filter.reportType.value);
